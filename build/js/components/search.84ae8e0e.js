import { status, initFlashcardHover, randomAnime } from './initializer.edf0c01b.js';
import { BASE_URL, searchAnime, getTopRatedAnime, getMostPopularAnime, getGenres, genres } from '../api.07c15c0a.js';
import { createSection, createFlashcard } from './UIs.a924b895.js';
import { loadCSS, showLoader, hideLoader, updateMetaTags } from '../pages.e03c3ec6.js'
const activeFilters = {};
...
export async function loadSearchPage() {
    ...
    loadCSS('./css/search.58cedfd9.css');
