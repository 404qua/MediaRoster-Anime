...
import { loadCSS, hideLoader, showLoader, load404, updateMetaTags } from '../pages.e03c3ec6.js';
import { escapeHTML } from './UIs.a924b895.js';
import { initAuthUI } from './auth.032ed004.js';
import { getAnimeDetails } from '../api.07c15c0a.js';
...
export async function loadProfilePage(cachedAuth = null, targetUsername = null) {
    loadCSS('./css/profile.ff4e1ab2.css');
