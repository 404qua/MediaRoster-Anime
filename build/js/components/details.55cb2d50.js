import { getAnimeDetails, getAnimeCharacters, getAnimeStaff, getAnimeInfo, getRandomAnime, getAnimeReviews } from '../api.07c15c0a.js';
import { initFlashcardHover, initGalleryControls, randomAnime } from './initializer.edf0c01b.js';
import { showLoader, hideLoader, loadCSS, load404, updateMetaTags } from '../pages.e03c3ec6.js';
import { createFlashcard, escapeHTML } from './UIs.a924b895.js';
import { supabase } from '../supabase.bc85885d.js';

export async function loadDetailsPage(animeId = null) {
  console.log(`Loading Details for anime ID: ${animeId}`);
  loadCSS('./css/details.dea2bcff.css');
